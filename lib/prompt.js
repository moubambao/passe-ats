...
export function buildPrompt({ cv, job, missing = [], lang = 'auto', tone = 'sobre' }) {
  ...
  const budget = tone === 'detaille'
    ? "FORMAT : deux pages maximum (600 à 800 mots). Résumé de 3-4 lignes, 3 à 5 puces par poste, 6 expériences maximum."
    : tone === 'concis'
      ? "FORMAT : UNE SEULE PAGE, impérativement (300 à 380 mots au total). Résumé de 2 lignes, 3 puces courtes par poste (2 pour les postes anciens), 4 expériences maximum, 3 catégories de compétences maximum."
      : "FORMAT : UNE SEULE PAGE, impérativement (350 à 480 mots au total). Résumé de 3 lignes maximum, 3 à 4 puces d'une ligne par poste (2 pour les postes de plus de 8 ans), 5 expériences maximum (fusionne ou résume les plus anciennes en une ligne), 3 catégories de compétences maximum, formation en une ligne par diplôme.";
...
6. Chaque puce : une phrase courte (15 mots maximum), idéalement avec un résultat mesurable SI le chiffre existe dans le CV d'origine.
...
8. ${budget} Un CV qui dépasse ce budget sera rejeté : priorise ce qui correspond à l'offre et supprime le reste.
